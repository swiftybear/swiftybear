...
if(isset($_POST["category"])){
	...
	echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active'><a href='#'><h4>Basic Commodities</h4></a></li>
	";
...
if(isset($_POST["brand"])){
	...
	echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active'><a href='#'><h4>Local Stores</h4></a></li>
	";
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			$bid = $row["brand_id"];
				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									<img src='product_images/$pro_image' style='width:200px; height:250px;'/>
								</div>
								<div class='panel-heading'>₱ $pro_price
									<button pid='$pro_id' style='float:right;' id='product' class='btn btn-danger btn-xs'>AddToCart</button>
									<button pid='' style='float:center;' id='product' class='btn btn-warning btn-xs'>Compare Price</button>
										<button pid=''  id='product' class='btn btn-warning btn-xs'>Compare Local Store</button>
								</div>
							</div>
						</div>
			";
